        ...
        try
        {
            ...
            List<TLV> emvTags = new List<TLV>
            {
                ...
                new TLV { Id = "89", Name = "Authorisation Code",Length=6 },
                  new TLV { Id = "90", Name = "Biometric Solution ID",Length=-1},//VAR
                  new TLV { Id = "82", Name ="Biometric Subtype",Length=1},
                  new TLV { Id = "9F30", Name ="Biometric Terminal Capabilities",Length=3},
                  new TLV { Id = "BF4C", Name = "Biometric Try Counters Template",Length=-1},//VAR
                  new TLV { Id = "81", Name = "Biometric Type",Length=-1},//VAR
                  ...
                  new TLV { Id = "DF51", Name = "Enciphered Biometric Data",Length=-1},//VAR
                  ...
                  new TLV { Id = "9F2E", Name = "Integrated Circuit Card (ICC) PIN Encipherment Public Key Exponent",minLen=1,maxLen=3,orLength=true},// OR 
                  new TLV { Id = "9F2F", Name ="Integrated Circuit Card (ICC) PIN Encipherment Public Key Remainder",Length=42},
                   ...
                   new TLV { Id = "9F47", Name = "Integrated Circuit Card (ICC) Public Key Exponent",minLen=1,maxLen=3,orLength=true},//OR
                   ...
                   new TLV { Id = "9F0C", Name ="Issuer Identification Number Extended (IINE)",minLen=3,maxLen=4 ,orLength=true},//->Edit for OR
                   ...
                   new TLV { Id = "9F4F", Name = "Log Format ",Length=-1},// VAR
                   ...
                   new TLV { Id = "BF4B", Name = "Online BIT Group Template ",Length=-1},//->VAR
                   ...
                   new TLV { Id = "9F38", Name = "Processing Options Data Object List (PDOL)",Length=-1},//->Edit for VAR
                   new TLV { Id = "70", Name = "READ RECORD Response Message Template",minLen=0,maxLen=252},
                   new TLV { Id = "80", Name = "Response Message Template Format 1",Length=-1},//->Edit for VAR
                   new TLV { Id = "77", Name = "Response Message Template Format 2",Length=-1},//->Edit for VAR
                   ...
                   new TLV { Id = "9A", Name ="Transaction Date",Length=3},
                   new TLV { Id = "99", Name = "Transaction Personal Identification Number (PIN) Data",Length=-1},//->Edit for VAR
                   new TLV { Id = "9F3C", Name ="Transaction Reference Currency Code",Length=2},
                 ...
                 new TLV { Id = "5F54", Name = "Bank Identifier Code (BIC)",minLen=8,maxLen=11, orLength = true},//->Edit for OR 
                 new TLV { Id = "A1", Name = "Biometric Header Template (BHT)",Length=-1},//->Edit for VAR
                 new TLV { Id = "7F60", Name = "Biometric Information Template (BIT)",Length=-1},//->Edit for VAR
                 new TLV { Id = "9F31", Name = "Card BIT Group Template",Length=-1},//->Edit for VAR
                 new TLV { Id = "BF4E", Name = "Biometric Verification Data Template",Length=-1},//->Edit for VAR
                 ...
                 new TLV { Id = "83", Name = "Command Template",Length=-1},//->Edit for VAR
                 ...
                 new TLV { Id = "A5", Name = "File Control Information (FCI) Proprietary Template",Length=-1},//->Edit for VAR
                 ...
                 new TLV { Id = "9F32", Name = "Issuer Public Key Exponent",minLen=1,maxLen=3,orLength=true},//->Edit for OR 
                 ...
                 new TLV { Id = "71", Name = "Issuer Script Template 1",Length=-1},//->Edit for VAR
                 new TLV { Id = "72", Name = "Issuer Script Template 2",Length=-1},//->Edit for VAR
                 new TLV { Id = "5F50", Name = "Issuer URL",Length=-1},//->Edit for VAR
                 new TLV { Id = "9F15", Name = "Merchant Category Code",Length=2},
                 new TLV { Id = "9F16", Name = "Merchant Identifier",Length=15},
                 new TLV { Id = "9F4E", Name = "Merchant Name and Location",Length=-1},//->Edit for VAR
                 new TLV { Id = "BF4A", Name = "Offline BIT Group Template",Length=-1},//->Edit for VAR
                 new TLV { Id = "BF4D", Name = "Preferred Attempts Template23",Length=-1},//->Edit for VAR
                 ...
                 new TLV { Id = "9F4A", Name = "Static Data Authentication Tag List",Length=-1},//->Edit for VAR
                 new TLV { Id = "9F19", Name = "Token Requestor ID",Length=6},
                 new TLV { Id = "9F1F", Name = "Track 1 Discretionary Data",Length=-1},//->Edit for VAR
                 new TLV { Id = "9F20", Name = "Track 2 Discretionary Data",Length=-1},//->Edit for VAR
