...
namespace ISO
{
    ...
    internal class MessageFactory
    {
        ...
        private static string BalanceInquiry()
        {
            ...
            requiredDataelements.Add(new DataElement { Id = "DE-052", PositionInTheMsg = 52, Name = "Personal Identification Number (PIN) Data", Value = PinPanBlock.Encryption(requiredDataelements), FieldLengthRepresentation = LengthType.Fixed });
            ...
            requiredDataelements.Add(new DataElement { Id = "DE-054", PositionInTheMsg = 55, Name = "Integrated Circuit Card System Related Data", Value = "1010101010100010111101", FieldLengthRepresentation = LengthType.LL });
